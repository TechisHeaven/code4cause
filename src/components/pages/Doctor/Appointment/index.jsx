...
const index = () => {
  ...
  return (
    <div className="max-w-[1280px] m-auto">
      <div className="wrapper-heading text-center capitalize my-12 flex flex-col items-center gap-2">
        <h1 className="text-textMain text-4xl font-semibold">
        ...
        <div className="flex md:flex-row gap-2 flex-col sm:flex-col">
          ...
          <button className="bg-primary p-2 px-4 text-white rounded-md">
            Search Again
          </button>
        </div>
      </div>
      <div className="page-container min-h-[350px] h-full">
        ...
        <div className="doctor-items mb-8">
          <DoctorCards />
        </div>
        <button className="p-2 bg-primary text-white">Load more</button>
      </div>
    </div>
  );
};
